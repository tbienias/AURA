...
namespace HoloToolkit.Unity.InputModule
{
    ...
    /// </summary>
    public partial class LoggingKeywordManager : MonoBehaviour
    {
        [System.Serializable]
        ...
        [Tooltip("A response to be triggered for each recognised keyword.")]
        public StringEvent GenericResponse;
        ...
        private void ProcessKeyBindings()
        {
            foreach (var kvp in KeywordsAndResponses)
            {
                ...
                {
                    Debug.Log("Key pressed: " + kvp.KeyCode);
                    kvp.Response.Invoke();
                    return;
                }
            }
        ...
        private void KeywordRecognizer_OnPhraseRecognized(PhraseRecognizedEventArgs args)
        {
            ...
            if (responses.TryGetValue(args.text, out keywordResponse))
            {
                ...
                if (GenericResponse != null)
                    GenericResponse.Invoke("Keyword recognized: " + args.text);
